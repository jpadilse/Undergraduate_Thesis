...
Uncertainty has been a primary concern in economics and the sciences in general. Principally, since has been separated from risk [@knight:2014]. The distinction between risk and uncertainty is that the former can be described by a distribution function with the associated probability for each possibly outcome---where each possible outcome is known---while the latter can not be characterized in this terms. It is so important this distinction and both concepts by itself that @bernstein:1998 said that this divided the history, i.e., the mastering of both phenomena mark a break in study of sciences.
