...
\begin{equation}
    r_{t} = f(\Omega_{t}) + \epsi_{t} \quad (t = 1, 2, \dots, T) (\#eq:R)
\end{equation}

Where, $r_{t}$ is the effective federal funds rate (understood as the monetary policy instrument), $f$ is a linear function, $\Omega_{t}$ is an information set and $\epsi_{t}$ is the monetary policy shock, where it is assumed that $\epsi_{t}$ is orthogonal to $\Omega_{t}$.
