...
```{r non-asset-market-index, fig.cap = "(ref:non-asset-market-index)", fig.scap = "Non-Asset-Market-Index", out.extra = ""}
DFM_base %>% 
  ggplot(aes(Date, NAM)) + 
...
summary_table_raw <- tibble(
  Statistic = c(
    "Skewness", "Kurtosis", "Persistence, AR(1)", "Half-life (months)"
  ),
