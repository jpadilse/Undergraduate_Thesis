...
IP <- tq_get("INDPRO", get = "economic.data", from = "1972-01-01") %>% 
  transmute(
    Date = seq(ymd(19720201), ymd(20191201), by = "1 month") - 1,
