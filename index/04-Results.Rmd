...
(ref:fevd-plot) **Forecast Error Variance Decomposition in 11-variables VAR**: The figure shows the percentage of variance of the $h$-step-ahead forecast error due to a shocks of each variable, for $h = 1, \ldots, 60$.

```{r fevd-plot, fig.asp = 1.7, fig.cap = "(ref:fevd-plot)", fig.scap = "Forecast Error Variance Decomposition for in 11-variables VAR"}
fevd_tibble %>%
